...
<head>
    ...
    <title>Product Details |Jaguars</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +1 609 713 9044</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> info@sjsu.edu</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="/app"><img src="resources/images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/app/checkout1"><i class="fa fa-crosshairs"></i> Checkout</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="/app/product-details" class="active">Product Details</a></li> 
										<li><a href="/app/checkout1">Checkout</a></li> 
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href=""> <span class="pull-right">(56)</span>Canalli</a></li>
									<li><a href=""> <span class="pull-right">(27)</span>Banana Republic</a></li>
									<li><a href=""> <span class="pull-right">(32)</span>Chanel</a></li>
...
<button class = "black" style="background-color:#000000";"width:165;height:165">I</button>
<button class = "red" style="background-color:#FF0000";"width:165;height:165">I</button>
<button class = "lightblue" style="background-color:#66A3FF";"width:165;height:165">I</button>
<button class = "white" style="background-color:#FFFFFF";"width:165;height:165">I</button>
<button class = "green" style="background-color:#96E843";"width:165;height:165">I</button>
<button class = "darkblue" style="background-color:#0033CC";"width:165;height:165">I</button>
<button class = "yellow" style="background-color:#FFFF00";"width:165;height:165">I</button>
<button class = "winered" style="background-color:#990000";"width:165;height:165">I</button>
<button class = "orange" style="background-color:#FF6600";"width:165;height:165">I</button>
<input type="hidden" name="color" id="color"/>
<select id="component" name="component" class="btn btn-default dropdown-toggle usa" class="component" onchange="component(this.value)">
...
<div>
<input type="button" class="btn btn-default add-to-cart" onclick="displayOne()" value="Round collar "/>
<input type="button"  class="btn btn-default add-to-cart" onclick="displayTwo()" value="Polo Tshirt"/>
...
<input type="submit" value="Proceed" class="btn btn-default add-to-cart" name="submit" onsubmit="return checkAllValues()"/>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										...
										<li><a href=""><i class="fa fa-clock-o"></i>3:41 PM</a></li>
										<li><a href=""><i class="fa fa-calendar-o"></i>2 DEC 2014</a></li>
									</ul>
