...
<h1 style="text-align:center;color:orange">You may also like</h1>
...
<script>
  ...
  <div> 
  <h3 style="text-align:center;color:orange">Recommended color combinations</h3></div>    
...
<input type="hidden" id= "c35" value=${Prod2Neck} name="c35" />
<input type="hidden" id= "c45" value=${Prod3Neck} name="c45" />
<input type="hidden" id= "c55" value=${Prod4Neck} name="c55" />


<input type="hidden" id= "c11" value=${origProdTshirt} name="c11" />
<input type="hidden" id= "c21" value=${Prod1Tshirt} name="c21" />
<input type="hidden" id= "c31" value=${Prod2Tshirt} name="c31" />
<input type="hidden" id= "c41" value=${Prod3Tshirt} name="c41" />
<input type="hidden" id= "c51" value=${Prod4Tshirt} name="c51" />


<input type="hidden" id= "c12" value=${origProdCollar}  name="c12" />
<input type="hidden" id= "c22" value= ${Prod1Collar}  name="c22" />
<input type="hidden" id= "c32" value= ${Prod2Collar} name="c32" />
<input type="hidden" id= "c42" value= ${Prod3Collar} name="c42" />
<input type="hidden" id= "c52" value= ${Prod4Collar} name="c52" />


<input type="hidden" id= "c13" value=${origProdLogo} name="c13" />
<input type="hidden" id= "c23" value=${Prod1Logo} name="c23" />
<input type="hidden" id= "c33" value=${Prod2Logo} name="c33" />
<input type="hidden" id= "c43" value=${Prod3Logo} name="c43" />
<input type="hidden" id= "c53" value= ${Prod4Logo} name="c53" />


<input type="hidden" id= "c14" value=${origProdSleeves} name="c14" />
<input type="hidden" id= "c24" value=${Prod1Sleeves} name="c24" />
<input type="hidden" id= "c34" value=${Prod2Sleeves} name="c34" />
<input type="hidden" id= "c44" value=${Prod3Sleeves} name="c44" />
<input type="hidden" id= "c54" value= ${Prod4Sleeves} name="c54" />

<input type="submit" class="btn btn-fefault cart" id="proceed" value="Proceed" name="proceed"/>
				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="resources/images/cart/two.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">T-Shirt</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="resources/images/cart/three.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">T-Shirt</a></h4>
								<p>Web ID: 1089772</p>
