...
<form action = "/app/product1Data" method="POST">

<input type="hidden" name="TshirtColor" id="TshirtColor" value=""/>
<input type="hidden" name="Collar" id="Collar" value=""/>
<input type="hidden" name="Logo" id="Logo" value=""/>
<input type="hidden" name="Sleeves" id="Sleeves" value=""/>
<input type="hidden" name="TshirtType" id="TshirtType" value="type-collar"/>
